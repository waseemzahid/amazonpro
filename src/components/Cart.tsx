...
const handleReset = () => {
    ...
    //   title: 'Are you sure, you want to reset your Cart?',
      text: 'Are you sure you want to reset your Cart?',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        ...
        //     icon: 'success',
        //     title: 'Reset!',
        //     text: 'Your cart has been reset, Go Shopping',
        //     timer: 1500, 
  ...
  const handleCheckout = async () => {
    ...
    const response = await fetch("https://amazonpro-chi.vercel.app/api/checkout", {
      method: "POST",
        ...
        <div className="mt-5 flex flex-col">
              ...
              {productData.map((item: ProductType) => (
                <tbody key={item?._id}>
                  <tr className="bg-white border-b-[1px] border-b-zinc-300">
                    <th
                      scope="row"
                      className="px-6 py-4 flex items-center lg:gap-3"
                    >
                      <X
                        onClick={() => {
                    ...
                    <td className="px-6 py-4">
                      <FormattedPrice className="" amount={item?.price * item?.quantity} />
                    </td>
                    <td className="px-6 py-4">
          ...
          <div className="mt-4 bg-white max-w-xl p-4 flex flex-col gap-1">
            ...
            <p className="flex items-center justify-between">
              Price{" "}
              <span>
                <FormattedPrice className="" amount={rowPrice} />
              </span>
            </p>
            <p className="flex items-center justify-between">
              Discount{" "}
              <span>
                <FormattedPrice className="" amount={rowPrice - totalAmt} />
              </span>
            </p>
            <p className="flex items-center justify-between">
              Total Price{" "}
            ...
            <button
              ...
              className="bg-designColor my-2 py-2 uppercase text-center rounded-md font-semibold hover:bg-zinc-950 hover:text-white duration-200"
            >
              Proceed to Checkout
            </button>
          </div>
